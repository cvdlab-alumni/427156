...
#porta
#VIEW(hpc)
toMergeSalaPranzo = 15     

diagramDoorSalaPranzo2 = assemblyDiagramInit([1,3,2])([[1],[24,10,2],[16,6]]) 
...
hpcSalaPranzo = cellNumbering (masterSalaPranzo2,hpcSalaPranzo)(range(len(masterSalaPranzo2[1])),CYAN,2)
#VIEW(hpcSalaPranzo)
toRemoveSalaPranzo2 = [22]    
...
toMergeCucina = 7     
diagramDoorCucina2 = assemblyDiagramInit([3,1,2])([[26,10,4],[1],[16,6]]) 
...
toMergeSalone = 11     
diagramDoorSalone2 = assemblyDiagramInit([3,1,2])([[2,10,26],[1],[16,6]]) 
...
toMergeBagno_3 = 15     
diagramDoorBagno_32 = assemblyDiagramInit([1,3,2])([[1],[1,8,1],[16,6]]) 
...
toMergeStudio = 7     
diagramDoorStudio2 = assemblyDiagramInit([3,1,2])([[27,10,3],[1],[16,6]]) 
...
toMergeBagno_2 = 7     
diagramDoorBagno_22 = assemblyDiagramInit([3,1,2])([[1,8,20],[1],[16,6]]) 
...
toMergeBagno_1 = 3     
diagramDoorBagno_12 = assemblyDiagramInit([1,3,2])([[1],[3,10,8],[16,6]]) 
...
toMergeCamera_1 = 7     
diagramDoorCamera_12 = assemblyDiagramInit([3,1,2])([[1,8,19],[1],[16,6]]) 
...
toMergeCamera_2 = 3     
diagramDoorCamera_22 = assemblyDiagramInit([1,3,2])([[1],[27,8,1],[16,6]]) 
...
toMergeCamera_3 = 11     
diagramDoorCamera_32 = assemblyDiagramInit([3,1,2])([[4,8,23],[1],[16,6]]) 
...
modelPianerottolo = T([1,2])([10,110])(CUBOID([41,15,1]))
modelPianerottolo = DIFFERENCE([modelPianerottolo, (T([1,2])([10,125])(CYLINDER([6,1])(18)))])
...
copriScala = DIFFERENCE([CYLINDER([7,22])(18),CYLINDER([6,22])(18),T(2)(-7)(CUBOID([7,14,22])),T([1,2,3])([-8,-3,8])(CUBOID([6,6,8]))])
copriScalaT = T([1,2])([10,125])(copriScala)


modelPiano = STRUCT([modelSalaPranzo,modelCucina,modelBagno_1,modelBagno_2,modelBagno_3,modelSalone,modelStudio,modelCamera_1,modelCamera_2,modelCamera_3,modelCorridoio1,modelCorridoio2,parete1,parete2,parete3,modelPianerottolo,copriScalaT])

modelPiano = DIFFERENCE([modelPiano,T([1,2,3])([53,17,1])(CUBOID([2,22,22]))  ])
modelPiano = DIFFERENCE([modelPiano,finestre])
scala =  MAKEMODEL(spiralStair(3,6,2,2,21,12,18))
scalaT = STRUCT([T([1,2])([10,125])(scala),(T([1,2])([10,125])(CYLINDER([2,132])(18)))])
VIEW(STRUCT([modelPiano]))
modelPiano1 = STRUCT([modelPiano,T(2)(250)(S(2)(-1)(modelPiano))])
VIEW(modelPiano1)
modelPalazzo = STRUCT([modelPiano1,T(3)(22)]*6)



VIEW(STRUCT([modelPalazzo,scalaT]))
